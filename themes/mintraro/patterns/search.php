...
<p><?php esc_html_e('No results.', 'mintraro');?></p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
...
<h4 class="wp-block-heading"><?php esc_html_e('Search', 'mintraro');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Latest Posts', 'mintraro');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Categories', 'mintraro');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Tags', 'mintraro');?></h4>
<!-- /wp:heading -->
